...
const getAPI = {
  popularMovie: (page: number) => {
    return `${BASE_API_DOMAIN}/${POPULAR_API_PATH}?api_key=7346e1b315e7e7c5dc1e70459156cce2&language=ko-KR&page=${page}`;
  },
  searchMovie: (keyword: string, page: number) =>
    `${BASE_API_DOMAIN}/${SEARCH_API_PATH}?api_key=7346e1b315e7e7c5dc1e70459156cce2&language=ko-KR&query=${keyword}&page=${page}`,
